  ...
  return (
    ...
    >
      ...
      <Section title="٢. البيانات التي نجمعها">
        ...
        المخزّنة.
        <br />- بيانات طلبات المتجر: اسم المستلم ورقم الهاتف والمحافظة والمنطقة
        وعنوان التوصيل. نجمعها فقط لتوصيل طلباتك، ولا يطلع عليها إلا فريق المتجر
        المسؤول عن تجهيز الطلب وتوصيله.
