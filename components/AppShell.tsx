    ...
    <div className="flex min-h-screen">
      ...
      >
        ...
        <nav className="px-2 pb-2 space-y-0.5">
          ...
          <NavLink href="/store" active={pathname.startsWith('/store') && !pathname.startsWith('/store/orders')} icon={<ShoppingBag className="w-5 h-5" />} label="المتجر" />
          <NavLink href="/store/orders" active={pathname.startsWith('/store/orders')} icon={<ReceiptText className="w-5 h-5" />} label="طلباتي" />
